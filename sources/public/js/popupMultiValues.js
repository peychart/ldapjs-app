function initializePopup(container) {
    ...
    //const initValues = JSON.parse(editInput.value || "[]"); // Récupérer les valeurs initiales
    ...
    document.addEventListener('click', (event) => {
        if (!popupOptions.contains(event.target) && !editInput.contains(event.target))
    ...
    button.addEventListener('click', (event) => {
        ...
        // Ne pas mettre à jour le champ caché tant que l'entrée n'est pas remplie
