...
popup.innerHTML="<h2>Entrez votre mot de passe</h2><div class='input-container'><input type='password' id='passwordInput' placeholder='Votre mot de passe'/><button id='submitPassword'>Soumettre</button><button id='closePopup'>Fermer</button></div>";
